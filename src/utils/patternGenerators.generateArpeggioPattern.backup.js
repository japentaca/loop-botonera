/**
 * Backup of original generateArpeggioPattern
 * Saved before simplifying the arpeggiator so we can revert or rework later.
 * File created automatically by Copilot assistant.
 */
export function generateArpeggioPattern_backup({ length, scale, baseNote, noteRange, density, options = {} }) {
  ...
  // Compute positions. Keep the original fillAll bounce behaviour (continuous arpeggio)
  let positions = [];
