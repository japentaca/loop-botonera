<template>
  <Dialog :visible="isOpen" modal header="Configuración de Estilos" :style="{ width: '90vw', maxWidth: '800px' }"
        ...
        <div class="controls-grid">
          ...
          <div class="control-group">
            ...
            <div class="slider-container">
              <Slider :min="4" :max="32" :step="4" :modelValue="audioStore.evolveInterval"
                @update:modelValue="onEvolveIntervalChange" class="range-slider" />
          ...
          <div class="control-group">
            ...
            <div class="slider-container">
              <Slider :min="1" :max="10" :step="1" :modelValue="audioStore.evolveIntensity"
                @update:modelValue="onEvolveIntensityChange" class="range-slider" />
      ...
      <div class="config-section">
        ...
        <div class="controls-grid">
          ...
          <div class="control-group checkbox-group">
            <div class="checkbox-container">
              <label for="energyManagement" class="checkbox-label">
                <input type="checkbox" id="energyManagement" v-model="energyManagementEnabled"
          ...
          <div class="control-group">
            ...
            <div class="slider-container">
              <Slider :min="1.0" :max="5.0" :step="0.1" :modelValue="audioStore.maxSonicEnergy"
                @update:modelValue="onMaxSonicEnergyChange" class="range-slider" />
          ...
          <div class="control-group">
            ...
            <div class="slider-container">
              <Slider :min="0.1" :max="1.0" :step="0.05" :modelValue="audioStore.energyReductionFactor"
                @update:modelValue="onEnergyReductionFactorChange" class="range-slider" />
          ...
          <div class="control-group checkbox-group">
            <div class="checkbox-container">
              <label for="scaleLocked" class="checkbox-label">
                <input id="scaleLocked" type="checkbox" v-model="scaleLocked" class="custom-checkbox" />
    ...
    <template #footer>
      <Button label="Restaurar Valores por Defecto" icon="pi pi-refresh" severity="secondary"
        @click="resetToDefaults" />
      <Button label="Cerrar" icon="pi pi-check" @click="closeDialog" />
    </template>
  </Dialog>
</template>
